...
import { X, Minus, ArrowUpRightFromSquare } from 'lucide-react';
            ...
            <div className="relative w-[94vw] max-w-[94vw] h-[88vh] bg-zinc-950 rounded-xl overflow-hidden border border-white/20 shadow-2xl flex flex-col">
              ...
              <AnimatePresence>
                {showInfo && (
                  ...
                  >
                    <div className="bg-zinc-900 border border-white/20 rounded-lg p-6 max-w-md w-full text-white relative">
